...
const { getUsers, createUser, updateUser, deleteUser, updateProfile, updatePassword } = require('./user.controller');
 ...
 */
router.get('/partners', protect, require('./user.controller').findPartners);
router.get('/partners', protect, require('./user.controller').findPartners);
