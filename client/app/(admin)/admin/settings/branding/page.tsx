...
import { Loader2, Palette, Image as ImageIcon, Type, Save, Upload } from "lucide-react"
...
const brandingSchema = z.object({
    ...
    primaryForeground: z.string().regex(/^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/, "Invalid hex color").optional(),
    sidebarColor: z.string().regex(/^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/, "Invalid hex color").optional(),
})
...
export default function BrandingSettingsPage() {
    ...
    const onSubmit = async (values: BrandingFormValues) => {
        setSaving(true)
        try {
            await settingsService.updateConfig(values as any)
        ...
        <div className="max-w-4xl mx-auto py-8 px-4 space-y-8">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-muted-foreground">Customize your system appearance, brand name, and logo.</p>
                </div>
            </div>
                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                                                ...
                                                <FormControl>
                                                    <div className="flex flex-col gap-2">
                                                        <Input
                                                            ...
                                                            disabled={uploading}
                                                        />
                                                        <FormDescription>Upload your brand logo (max 5MB).</FormDescription>
                                                    </div>
                                                </FormControl>
                                                <FormMessage />
                                            </FormItem>
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Define your brand colors. These will be applied throughout the system.</CardDescription>
                        </CardHeader>
                        <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormDescription>Used for buttons, links, and primary UI elements.</FormDescription>
                                        <FormMessage />
                                    </FormItem>
                                )}
                            />
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel>Primary Foreground (Text on Theme Color)</FormLabel>
                                        <div className="flex gap-2">
                                            <FormControl>
                                                <Input type="color" className="w-12 h-10 p-1" {...field} />
                                            </FormControl>
