...
export const columns: ColumnDef<Offer>[] = [
    ...
    },
    {
        ...
        header: "Discount",
        cell: ({ row }) => <span className="text-green-600 font-bold">{row.getValue("discountPercentage")}%</span>
    },
    {
        accessorKey: "validUntil",
        header: "Valid Until",
        cell: ({ row }) => <span>{new Date(row.getValue("validUntil")).toLocaleDateString()}</span>
    },
    {
        id: "actions",
