    ...
    return (
        <div className="container mx-auto py-10 space-y-6">
            <div className="flex justify-between items-center">
                <div>
                    <h1 className="text-3xl font-bold tracking-tight">Booking Categories</h1>
                    <p className="text-muted-foreground">Manage types and visual styles for court bookings.</p>
                </div>
                                    ...
                                    {categories.length === 0 ? (
                                        ...
                                        categories.map((cat) => (
                                            <TableRow key={cat.id}>
                                                ...
                                                <TableCell className="font-mono text-xs">{cat.color}</TableCell>
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Input placeholder="e.g. Academy, Private, Tournament" {...field} />
                                        </FormControl>
                                        <FormMessage />
                                    </FormItem>
                                )}
