...
import { Loader2, Plus, Package as PackageIcon } from "lucide-react";
...
export default function CoachDashboardPage() {
    ...
    const [packages, setPackages] = useState<Package[]>([]); // This would ideally come from backend
    ...
    if (user?.role !== 'coach' && user?.role !== 'admin') {
        return <div className="p-8 text-center text-red-500">Access Restricted: Coaches Only</div>;
    }
