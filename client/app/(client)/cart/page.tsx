        ...
        <div className="max-w-md mx-auto space-y-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground text-lg">
              ...
              Explore our store for the best padel gear!
            </p>
          </div>
          <Button
            asChild
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
          ...
          <div className="lg:col-span-2 space-y-6">
            {items.map((item) => (
              <div
                key={item.id}
                className="bg-card rounded-3xl p-6 shadow-sm border flex flex-col sm:flex-row gap-6 items-center"
              >
              ...
              <div className="bg-primary/5 rounded-2xl p-4 border border-primary/10 flex gap-4">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Pay when you receive your order at the club.
                  </p>
                </div>
              </div>
