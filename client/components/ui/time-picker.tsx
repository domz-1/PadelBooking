                    ...
                    <div className="flex items-center justify-center gap-4">
                        <div className="flex flex-col items-center">
                            ...
                            <div className="flex gap-1 mt-1">
                                <Button
                                    ...
                                    variant="ghost"
                                    className="h-6 w-6"
                                    onClick={(e) => { e.stopPropagation(); incrementHour() }}
                                >
                                    ▲
                                </Button>
                                <Button
                                    ...
                                    variant="ghost"
                                    className="h-6 w-6"
                                    onClick={(e) => { e.stopPropagation(); decrementHour() }}
                                >
                                    ▼
                                </Button>
                            </div>
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <div className="flex gap-1 mt-1">
                                <Button
                                    ...
                                    variant="ghost"
                                    className="h-6 w-6"
                                    onClick={(e) => { e.stopPropagation(); incrementMinute() }}
                                >
                                    ▲
                                </Button>
                                <Button
                                    ...
                                    variant="ghost"
                                    className="h-6 w-6"
                                    onClick={(e) => { e.stopPropagation(); decrementMinute() }}
                                >
                                    ▼
                                </Button>
                            </div>
                        ...
                        <div className="flex flex-col items-center justify-center">
                            <Button
                                ...
                                onClick={(e) => { e.stopPropagation(); setPeriod("AM") }}
                            >
                                AM
                            </Button>
                            <Button
                                ...
                                onClick={(e) => { e.stopPropagation(); setPeriod("PM") }}
                            >
                                PM
                            </Button>
                        </div>
