...
export default function BookingGrid({
  ...
  const [showConvertToOpenMatchModal, setShowConvertToOpenMatchModal] =
    useState(false);
  ...
  const [adminCreateSlot, setAdminCreateSlot] = useState<{
    venueId: number;
    venueName: string;
    time: string;
  } | null>(null);
  ...
  const isUserInOpenMatch = (booking: Booking) => {
    ...
    return booking.openMatchPlayers.some(
      ...
      {loading ? (
        ...
        <>
          ...
          <div className="w-full bg-card rounded-lg shadow-sm border p-4">
                          ...
                          <div className="flex items-center gap-2">
                            {[1, 1.5, 2].map((dur) => (
                              <Button
                                key={dur}
                                variant={
                                  editDuration === dur ? "default" : "outline"
                                }
                                size="sm"
            ...
            >
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    This will cancel your booking. You cannot undo this action
                    if someone else books the slot.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
            ...
            {/* Open Match Modal */}
            <Dialog
              open={showOpenMatchModal}
              onOpenChange={setShowOpenMatchModal}
            >
              <DialogContent className="max-w-md">
                ...
                <div className="py-6 space-y-6">
                  ...
                  <p className="text-center text-sm text-muted-foreground">
                    Select one of your existing bookings to convert it to an
                    Open Match that others can join.
                  </p>
                  ...
                  <div className="space-y-4">
                    ...
                    {bookings.filter(
                      ...
                      <div className="text-center py-6 text-sm text-muted-foreground">
                        You do not have any bookings for today. Create a regular
                        booking first, then convert it to an Open Match.
                      </div>
                    )}
                  </div>
                </div>
                <DialogFooter>
                  <Button
                    variant="outline"
                    onClick={() => setShowOpenMatchModal(false)}
                  >
                    Cancel
                  </Button>
                </DialogFooter>
            ...
            <Dialog
              open={showConvertToOpenMatchModal}
              onOpenChange={setShowConvertToOpenMatchModal}
            >
              <DialogContent className="max-w-md">
                <DialogHeader>
