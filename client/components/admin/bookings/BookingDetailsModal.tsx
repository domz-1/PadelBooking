                    ...
                    <div className="grid grid-cols-2 gap-6">
                        <div className="space-y-4">
                            ...
                            <div className="space-y-3">
                                <div className="flex items-center gap-3">
                                    <Badge variant="outline" className="h-8 w-8 rounded-lg flex items-center justify-center p-0 border-primary/20 bg-primary/5">
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm font-bold text-green-600">{booking.totalPrice} USD</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="bg-muted/30 rounded-xl p-4 flex items-center gap-4">
                            ...
                            <div className="flex-1 min-w-0">
                                <p className="font-bold truncate">{booking.User?.name || 'Unknown Customer'}</p>
