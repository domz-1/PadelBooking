<template>
  <div class="space-y-6">
    ...
    <div v-if="showText">
      ...
      <input
        type="text"
        :value="modelValue[textKey]"
        @input="updateField(textKey, ($event.target as HTMLInputElement).value)"
    ...
    <div v-if="showPlaceholder">
      ...
      <input
        type="text"
        :value="modelValue[placeholderKey]"
        @input="updateField(placeholderKey, ($event.target as HTMLInputElement).value)"
    ...
    <div v-if="showSelect">
      ...
      <div class="relative z-20 bg-transparent">
        <select
          :value="modelValue[selectKey]"
          @change="updateField(selectKey, ($event.target as HTMLSelectElement).value)"
          class="dark:bg-dark-900 h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 pr-11 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800"
          :class="{ 'text-gray-800 dark:text-white/90': modelValue[selectKey] }"
        >
    ...
    <div v-if="showPassword">
      ...
      <div class="relative">
        <input
          ...
          :value="modelValue[passwordKey]"
          @input="updateField(passwordKey, ($event.target as HTMLInputElement).value)"
    ...
    <div v-if="showDate">
      ...
      <div class="relative">
        <flat-pickr
          :modelValue="modelValue[dateKey]"
          @update:modelValue="updateField(dateKey, $event)"
    ...
    <div v-if="showTime">
      ...
      <div class="relative">
        <flat-pickr
          :modelValue="modelValue[timeKey]"
          @update:modelValue="updateField(timeKey, $event)"
    ...
    <div v-if="showPayment">
      ...
      <div class="relative">
        <input
          type="text"
          :value="modelValue[paymentKey]"
          @input="updateField(paymentKey, ($event.target as HTMLInputElement).value)"
...
const props = withDefaults(
  ...
  {
    textLabel: 'Input',
    placeholderLabel: 'Input with Placeholder',
    placeholderText: 'info@gmail.com',
    ...
    textKey: 'input',
    placeholderKey: 'inputWithPlaceholder',
